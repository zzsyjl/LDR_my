...
def test_acc():
    ...
    n_comp = 10
    # root = os.path.dirname(args.cfg) # original code, no use
    # root = 'logs/cifar10_LDR_multi_mini_dcgan' # my trained, with ngf=64
    root = 'logs/0227_mnist_forHAOYU'
    # root = 'mnist/LDR_multi_mode1' # downloaded ckpt of mnist
    # root = 'cifar10/LDR_multi_mode2_mini_dcgan' # downloaded ckpt of cifar10
    ...
    # netd_ckpt = '/home/yangjinglong/iLDR_Mayi/MyImplement/logs/my_ictrl_prototype_stepnum_is_5k/checkpoints/netD/netD_0_steps.pth'
    # netg_ckpt = '/home/yangjinglong/iLDR_Mayi/MyImplement/logs/my_ictrl_prototype_stepnum_is_5k/checkpoints/netG/netG_0_steps.pth'
    ...
    # # print(netG_state_dict['model_state_dict']['main.0.conv1.weight'].shape)
